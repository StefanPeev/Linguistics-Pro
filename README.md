...
# Linguistics Pro
**Linguistics Pro** is a part of the project **LOCAL FONT** for development of <code>free-to-use fonts</code> with the *modern Bulgarian letterform model* in the Cyrillic Unicode range. The project as a whole is based on an existing fonts under licenses which permit modifications and derivative works. An other font in this project is [**Cova**l](https://github.com/StefanPeev/coval).
